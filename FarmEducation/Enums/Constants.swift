...
enum Constants {
    enum UI {
        ...
        static let lastScore = "last_score"
    ...
    enum Background{
        static let farm = "farmBackground"
        static let question = "questionBackgroud"
    ...
    enum Colors {
        static let  forest = "forestColor"
        static let home = "homeColor"
        static let farm = "farmColor"
