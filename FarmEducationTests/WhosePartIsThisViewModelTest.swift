//
//  WhosePartIsThisViewModelTest.swift
//  FarmEducationTests
//
...
final class WhosePartIsThisViewModelTest: XCTestCase {
    var vm: WhosePartIsThisViewModel!
    ...
    override func setUp() {
        ...
        vm = WhosePartIsThisViewModel(gameType, audioManager)
    }
